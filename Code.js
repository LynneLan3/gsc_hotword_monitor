...
function onOpen() {
  SpreadsheetApp.getUi()
    ...
    .addItem('授权GA4 Admin写入', 'authorizeGa4AdminWrite')
    .addItem('发现GA4站点绑定', 'discoverGa4SiteBindings')
    .addItem('Bootstrap缺失GA4站点', 'bootstrapMissingGa4Sites')
    .addItem('修复MortalShell GA4 URI', 'fixMortalShellGa4DefaultUri')
