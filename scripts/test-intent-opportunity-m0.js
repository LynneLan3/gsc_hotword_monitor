...
assert(skip.action === 'EXISTING_GROWTH', 'skip page existing growth');
...
assert(optimize.action === 'OPTIMIZE_EXISTING', 'low CTR high-position existing page optimizes');
...
var fullRows = lightRows.concat([
  ...
  row('mortal shell 2 slayer seal difficulty', '/mortal-shell-ii/slayer-seal-difficulty/', 1, 116, 11),
